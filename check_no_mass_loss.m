...
% Input a trajectory over N time steps to ensure A_prime and the periods do
% not change when M_L = 0 and M_L = 1110, to demonstrate that we have
% are using a pseudomass without creating or removing mass.

function check_no_mass_loss(x, N)   
close all
test = [0, 1110];
%% System Parameters
global L_1 L_2                                             
...
L_1 = .5; 
L_2 = .5; 
% center of mass position in x direction, m (excludes any mass added in future) 
